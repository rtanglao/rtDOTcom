...
<details>
<summary>I like this example of adding a field called `Type` with in a select from [sqlitetutorial.net's UNION ALL tutorial](https://www.sqlitetutorial.net/sqlite-union/)</summary>
```sql
SELECT
  FirstName,
  LastName,
